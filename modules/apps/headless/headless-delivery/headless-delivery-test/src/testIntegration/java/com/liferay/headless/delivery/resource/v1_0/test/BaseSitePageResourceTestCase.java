		...
		testGetSiteSitePagesPageWithSort(
			...
			(entityField, sitePage1, sitePage2) -> {
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						sitePage1, entityField.getName(), 0.1);
				}

				if (BeanTestUtil.hasProperty(
						sitePage2, entityField.getName())) {

					BeanTestUtil.setProperty(
						sitePage2, entityField.getName(), 0.5);
				}
			});
	}
		...
		testGetSiteSitePagesPageWithSort(
			...
			(entityField, sitePage1, sitePage2) -> {
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						sitePage1, entityField.getName(), 0);
				}
				...
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						sitePage2, entityField.getName(), 1);
				}
			});
	}
