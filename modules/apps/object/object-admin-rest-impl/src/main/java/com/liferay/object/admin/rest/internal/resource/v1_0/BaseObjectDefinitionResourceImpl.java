...
public abstract class BaseObjectDefinitionResourceImpl
	...
	public ObjectDefinition patchObjectDefinition(
		...
		if (objectDefinition.getAllowStandaloneObjectEntry() != null) {
			existingObjectDefinition.setAllowStandaloneObjectEntry(
...
// LIFERAY-REST-BUILDER-HASH:1291811322