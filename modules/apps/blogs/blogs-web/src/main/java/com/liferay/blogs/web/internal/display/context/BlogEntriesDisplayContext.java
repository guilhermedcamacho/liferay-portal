...
public class BlogEntriesDisplayContext {
	...
	public BlogEntriesDisplayContext(
		RenderRequest renderRequest, RenderResponse renderResponse, Html html,
	...
	public BlogsEntryVerticalCard getBlogsEntryVerticalCard(
		...
		return new BlogsEntryVerticalCard(
			blogsEntry, _html, _renderRequest, _renderResponse, rowChecker,
			_trashHelper, rowURL, themeDisplay.getPermissionChecker(),
			resourceBundle);
	}
