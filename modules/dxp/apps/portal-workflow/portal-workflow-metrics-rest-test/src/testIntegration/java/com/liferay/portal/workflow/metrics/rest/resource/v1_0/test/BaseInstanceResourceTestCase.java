		...
		testGetProcessInstancesPageWithSort(
			...
			(entityField, instance1, instance2) -> {
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						instance1, entityField.getName(), 0.1);
				}

				if (BeanTestUtil.hasProperty(
						instance2, entityField.getName())) {

					BeanTestUtil.setProperty(
						instance2, entityField.getName(), 0.5);
				}
			});
	}
		...
		testGetProcessInstancesPageWithSort(
			...
			(entityField, instance1, instance2) -> {
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						instance1, entityField.getName(), 0);
				}
				...
				if (BeanTestUtil.hasProperty(
					...
					BeanTestUtil.setProperty(
						instance2, entityField.getName(), 1);
				}
			});
	}
